...
$[0b;
    ...
    model:backPropogation[weightsBiases;x_train;y_train;x_test;y_test;20;`model;0.05]
    ];[
    ...
    model:backPropogation[weightsBiases;trainingInput;trainingExpected;testInput;testExpected;20;`model;0.1]
    ]
 ]
